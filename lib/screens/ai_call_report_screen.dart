...
class AiCallReportScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: ListView(
      ...
      children: [
        ...
        _section('Focus tip', report.focusTip),
        if (report.vocabulary.isNotEmpty)
          _section('Words you used', report.vocabulary.join(' · ')),
        if (report.culturalNote != null)
          _section('Cultural note', report.culturalNote!),
